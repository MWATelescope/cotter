...
\end{equation}
This suggest that a uniform discretization in $w$ is optimal (TODO this is in contrast to what Cornwell 2008 says -- mailed Cornwell to ask why). From Eq.~\eqref{eq:minimum-w-distance}, the required number of layers can be derived and is given by
...
Panel~\ref{fig:timing-channels} shows performance versus the spectral output resolution. The cost of imaging multiple frequencies is the cost of making an image from fewer visibilities times the number of frequencies. FFTs become the dominant cost for such small visibility sets, and the number of imaged frequencies affect performance linearly.
...
TODO say something about error of analytical function vs measurements.

\begin{table*}
\caption{Predicted computational cost for various configurations, based on multi-frequency synthesis with 5 major iterations observing for 1 hour at ZA=20\degree.  Predictions are for $w$-projection in CASA, $w$-stacking with WSClean and $w$-stacked 12$\times$5-min snapshots with WSClean, with approximately equal accuracy.}
\begin{tabular}{lrrrrrrrrrr|rrr}
 Configuration&$\lambda$&FWHM  & Beams & Ant & Res & $\max |\Delta \mathbf{x}|$ & $\max \Delta z$ & int. t & BW & $\Delta \nu$ & $w$-proj & $w$-stack & $w$-snaps \\
          & (m)       &       &       &     &     & (km)                       & (m)             & (s)    & (MHz) &  (kHz) &  &  & \\
\hline
 GLEAM    &  2   & 24.7\degree& 1    & 128 & 2'   & 2.9 & 5 & 2 & 32 & 40     &14h 02m & 1h 52m & 1h 23m \\
 EMU      & 0.2  & 1\degree   & 30   &  36 & 10''  & 6 &  0 &10 & 300 & 20    &19h 49m &14h 12m & 14h 13m\\
 MSSS low &  5   & 9.8\degree & 5    &  20 & 100'' & 5 &    &10 & 16 & 16     & 2h 30m & 0h 11m & 0h 11m\\
 MSSS high&  2   & 3.8\degree & 5    &  40 & 120'' & 5 &    &10 & 16 & 16     & 2h 31m & 0h 38m & 0h 39m\\
 AARTFAAC &  5   & 45\degree  & 1    & 288 &  20'  & 0.3& 1 & 1 &  7 & 24     & 10h 47m & 4h 58m & 4h 58m \\
 VLSS     & 4.1  & 14\degree  & 1    &  27 &  80'' &11.1& 0 &10 & 1.56 & 12.2 & 0h 32m & 0h 12m & 0h 02m\\
 SKA-P1 AA inner&3& 1.2\degree& 480  &  35 & 140'' &2.5& 2 &1.2 & 380 & 1     & 3218 d & 1865 d  & 1865 d \\
 SKA-P1 AA mid&3 & 1.2\degree & 480  &  50 & 3.5'' &100& 50 &1.2 & 380 & 1     & 6658 d & 3843 d & 3844 d \\
\end{tabular}
\end{table*}
...
\section{Application of WSClean to other telescopes} \label{sec:application-to-nonmwa}
TODO
...
TODO discuss fact that w-projection needs layers for multi-threading.

TODO discuss optimalisations with GPUs
