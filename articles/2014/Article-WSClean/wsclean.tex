...
\begin{tabular}{lrrrrrrr}
 Survey   & $\lambda$ & FWHM  & Resolution & $\max |\Delta \mathbf{x}|$ & $\max \Delta z$ & int. time & B/$\delta \nu$ \\
\hline
 GLEAM    &           &       & 2'     & 2.9~km & 5~m & 2~s & 32~MHz/40~kHz\\
 EMU wide & 20 cm  & 1\degree & 10''    & 6~km &  0~m &     & ?/?\\
 MSSS low &  5 m   & 9.8\degree & 100'' & 5~km &      &10~s & 16~MHz/4~khZ\\
 MSSS high&  2 m   & 3.8\degree & 120'' & 5~km &      &10~s & 16~MHz/4~khZ\\
\end{tabular}
\end{table*}
