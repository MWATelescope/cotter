...
\begin{table}[h]
 \caption{Scaling of the computational cost for various operations} \label{tbl:computational-cost-per-operation}
 \begin{tabular}{lll}
...
\begin{equation}
\textrm{TC}_\textrm{wstacking}=\mathcal{O}\left(N^2_\textrm{pix} \log N_\textrm{pix} \sin \alpha_\textrm{FOV}+ N_\textrm{vis} \right),
\end{equation}
