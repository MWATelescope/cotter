...
plot "timings-ZA010-nsamples-wsc.txt" using 2:(column(3)/60) with lines lw 2.0 lt 1 lc 1 title "WSClean", \
     ...
     "timings-zenith-nsamples-casa.txt" using 2:(column(3)/60):(column(4)*5/60) with errorbars lt 1 lc 3 title "", \
		 "fit-ZA010-wsc.txt" using 1:(column(2)/60) with lines lt 1 lc 1 title "", \
		 "fit-ZA010-casa.txt" using 1:(column(2)/60) with lines lt 1 lc 3 title "",\
		 "fit-zenith-wsc.txt" using 1:(column(2)/60) with lines lt 1 lc 1 title "",\
		 "fit-zenith-casa.txt" using 1:(column(2)/60) with lines lt 1 lc 3 title "",\
