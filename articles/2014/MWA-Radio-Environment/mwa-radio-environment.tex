...
\UWA{}ICRAR, University of Western Australia, Crawley, WA 6009, Perth, Australia\\
...
\caption{Visibility amplitude distributions with logarithmic axes. The dashed line represent fits to the function $N=\beta S^\alpha$ over a reasonably constant part of the tail (selected by eye) of the RFI distribution, resulting in $\alpha=-1.37$ for GLEAM, $\alpha=-4.47$ for EoR high, and $\alpha=-1.33$ for EoR low.}
\label{fig:lognlogs}
\end{center}
\end{figure*}
