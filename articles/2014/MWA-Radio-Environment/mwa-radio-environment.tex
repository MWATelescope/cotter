...
\caption{Observed visibility RMS in the high-resolution (40~kHz) channels for each observation. This is the residual noise in the visibilities after RFI detection and flagging. A few channels in the FM bands show a deviating standard deviation, and observation `GLEAM 2014-03-17' shows DTV contamination around 180~MHz. The variability over nights is caused by the different celestial observing times and pointing directions, and therefore different apparent brightness of e.g. the Galaxy.}
