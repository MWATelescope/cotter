...
\hline
\multicolumn{3}{|r|}{\textbf{Total}} & \textbf{63h} & \textbf{0.96\%} & \textbf{0.5\%}\\
\hline
\end{tabular}
\end{table*}
...
The second last column of Table~\ref{tbl:obs-list} list for each of the observation nights the ratio of samples that were classified as RFI by the \textsc{aoflagger}. 
