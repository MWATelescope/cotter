...
"noise-vs-integrationtime-data.txt" using (column(1)):6 title "Peeled Uniform" with points lw 2, \
"noise-vs-integrationtime-data.txt" using (column(1)):7 title "Peeled Briggs'(0)" with points lw 2, \
"noise-vs-integrationtime-data.txt" using (column(1)):8 title "Peeled Briggs'(0.5)" with points lw 2, \
