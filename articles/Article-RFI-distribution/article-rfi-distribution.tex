...
\editmark{Hata} gives the following analytical estimate for $L_p$, the electromagnetic propagation loss between two ground-based antennas:
\begin{align} 
