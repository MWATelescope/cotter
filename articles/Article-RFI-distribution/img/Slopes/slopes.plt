...
plot \
"lba-slope-data-unsmoothed.txt" using 2:3 with lines title 'LBA Total' lw 3.0 lt 1 lc rgb "#FF8000", \
"hba-slope-data-unsmoothed.txt" using 2:3 with lines title 'HBA Total' lw 3.0 lt 2 lc rgb "#0080FF", \
